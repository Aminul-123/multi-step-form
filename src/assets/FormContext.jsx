...
const FormContext = createContext()
    ...
    function reducer (state, action) {
        switch(action.type) {
            case 'form/name' : return {
                ...state,
                name : action.payload, 
            }
            case 'form/email' : return {
                ...state,
                email : action.payload, 
            }
            case 'form/phone' : return {
                ...state,
            ...
            case 'summary/prev' : return {
                ...state,
                status : 'ADD_ONS',
                statusId :  state.statusId - 1,
            }
            case 'first/opt' : return {
                ...state,
...
function FormProvider ( {children}) {
    ...
    const {name, email, phone, status, statusId ,
        selectedOption,  firstOpt, secOpt, thirdOpt
    } = state;

    return <FormContext.Provider value={{
        name, email, phone, dispatch, status , statusId,
        selectedOption, firstOpt, secOpt, thirdOpt
    }} >
        {children}
